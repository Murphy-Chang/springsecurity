package cn.mine.springsecurity.security.config;

import cn.mine.springsecurity.security.filter.CaptchaAuthenticationFilter;
import cn.mine.springsecurity.security.handler.CustomLoginFailureHandler;
import cn.mine.springsecurity.security.handler.CustomLoginSuccessHandler;
import cn.mine.springsecurity.security.handler.CustomLogoutSuccessHandler;
import cn.mine.springsecurity.security.service.CustomAccessDecisionManager;
import cn.mine.springsecurity.security.service.CustomJdbcTokenRepositoryImpl;
import cn.mine.springsecurity.security.service.CustomUserService;
import cn.mine.springsecurity.security.filter.CaptchaAuthenticationFilter;
import cn.mine.springsecurity.security.handler.CustomLoginFailureHandler;
import cn.mine.springsecurity.security.handler.CustomLoginSuccessHandler;
import cn.mine.springsecurity.security.handler.CustomLogoutSuccessHandler;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
    	...
    	http.rememberMe()//开启持久化登录功能
			...
			.key("springsecurity")//持久化登录功能的加密加盐
